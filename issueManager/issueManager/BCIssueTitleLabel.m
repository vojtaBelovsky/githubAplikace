...
{
  BCIssueTitleLabel *label = [[BCIssueTitleLabel alloc] initWithFont:TITLE_FONT];
  [label setText:givenText];
  CGRect labelFrame = CGRectZero;
  labelFrame.size = [BCIssueTitleLabel sizeOfLabelWithText:givenText font:TITLE_FONT width:ISSUE_WIDTH-2*OFFSET];
